...
\begin{figure}
\center
<<task_1_plot, fig=TRUE, fig.width=4cm , echo=False>>=
  plot(seq(-2,2,.1), powers_student, cex = .9 , pch = 16, xlab=latex2exp('$\\mu_1-\\mu_2$'), ylab="power")
  points(seq(-2,2,.1), powers_welch, cex = .9, pch = 16, col='red')
  points(seq(-2,2,.1), powers_wilcoxon, cex = .9, pch = 16, col='blue')
  legend('right', c('Student t-test', 'Welsh test', 'Wilcoxon test'), pch = 16, col = c('black', 'red', 'blue'))
@
\label{chart_t1}
...
\begin{figure}
\center
<<task_2_plot, fig=TRUE, fig.width=4cm , echo=False>>=
  plot(seq(-2,2,.1), powers_student, cex = .9 , pch = 16, xlab=latex2exp('$\\mu_1-\\mu_2$'), ylab="power")
  points(seq(-2,2,.1), powers_welch, cex = .9 , pch = 16, col='red')
  points(seq(-2,2,.1), powers_wilcoxon, cex = .9 , pch = 16, col='blue')
  legend("right", c('Student t-test', 'Welsh test', 'Wilcoxon test'), pch = 16, col = c('black', 'red', 'blue'))
...
\begin{figure}
\center
<<task_3_plot, fig=TRUE, fig.width=4cm , echo=False>>=
  plot(seq(-2,2,.1), powers_student, cex = .9 , pch = 16, xlab=latex2exp('$\\mu_1-\\mu_2$'), ylab="power")
  points(seq(-2,2,.1), powers_welch, cex = .9 , pch = 16, col='red')
  points(seq(-2,2,.1), powers_wilcoxon, cex = .9 , pch = 16, col='blue')
  legend("right", c('Student t-test', 'Welsh test', 'Wilcoxon test'), pch = 16, col = c('black', 'red', 'blue'))
