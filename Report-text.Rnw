...
plot(model_simple$fitted.values[seq(1, to=54000, by = 50)])
points(diamonds_data_omited$price[seq(1, to=54000, by = 50)], col = 'red')
@
...
model_middle <- glm(formula = price~color+clarity+x+carat, data = diamonds_data_omited,
                    family = gaussian())
plot(model_middle$fitted.values[seq(1, to=54000, by = 50)])
points(diamonds_data_omited$price[seq(1, to=54000, by = 50)], col = 'red')
@
...
plot(model_complex$fitted.values[seq(1, to=54000, by = 50)])
points(diamonds_data_omited$price[seq(1, to=54000, by = 50)], col = 'red')
@
