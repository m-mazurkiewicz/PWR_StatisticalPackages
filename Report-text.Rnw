...
<<model_assumptions_simple, fig=TRUE, echo=FALSE, eval=TRUE>>=
layout(matrix(1:4, byrow = T, ncol = 2))
plot(model_simple, which = 1:4)
@

<<model_assumptions_midd, fig=TRUE, echo=FALSE, eval=TRUE>>=
layout(matrix(1:4, byrow = T, ncol = 2))
plot(model_middle, which = 1:4)
@

<<model_assumptions_complex, fig=TRUE, echo=FALSE, eval=TRUE>>=
layout(matrix(1:4, byrow = T, ncol = 2))
...
\begin{figure}
\begin{center}
<<model_without_outliers, echo=FALSE, fig=TRUE, eval=TRUE>>=
layout(matrix(1:4, byrow = T, ncol = 2))
...
\begin{tabular}[c]{@{}l@{}}Model with only continous\\variables without outliers\end{tabular} 
 & 3                   & 848300 & 0.0\%                                                                                      \\
\begin{tabular}[c]{@{}l@{}}Model with only continous\\variables with outliers\end{tabular}      & 3                   & 848800 & -0.06\%                                                                                    \\
\begin{tabular}[c]{@{}l@{}}Model with only continous\\and categorical variables\end{tabular}     & 4                   & 912700 & -7.6\%                                                                                     \\
