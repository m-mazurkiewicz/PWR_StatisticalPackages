...
<<data_visualisation_categorical_variables, fig=TRUE , fig.width=6, echo=False>>=
...
<<correlation_plot, fig=TRUE , fig.width=6, echo=False>>=
  ggcorr(diamonds_data_omited)
@
...
<<model assumptions, fig=TRUE, echo=FALSE, eval=TRUE>>=
