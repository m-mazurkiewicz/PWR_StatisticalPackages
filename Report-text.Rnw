...
The figure \ref{dist_price} is a visualization of distribution of prices. The chart shows that the most common are relatively cheap diamonds. Then if the price increase the diamond becomes rare.
